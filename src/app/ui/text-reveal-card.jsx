...
export const TextRevealCard = ({ text, revealText, children, className }) => {
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#1d1c20] border mb-16 border-white/[0.08] w-[25rem] rounded-lg p-4 relative overflow-hidden",
        className
      )}
    >
      {children}
      ...
      <div className="h-20 relative flex items-center justify-center overflow-hidden">
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-[2rem] py-10 font-bold bg-clip-text text-transparent bg-[#555564]">
            {text}
          </p>
          <MemoizedStars />
        </div>
